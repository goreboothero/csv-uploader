 ...
 */
class getTest_PrivateServicesLocatorService extends Goreboothero_CsvUploader_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'Goreboothero\\CsvUploader\\Form\\FormFactoryBuilder' => ['privates', 'Goreboothero\\CsvUploader\\Form\\FormFactoryBuilder', 'getFormFactoryBuilderService', true],
            'Goreboothero\\CsvUploader\\Form\\Type\\CsvUploaderType' => ['privates', 'Goreboothero\\CsvUploader\\Form\\Type\\CsvUploaderType', 'getCsvUploaderTypeService', true],
            'Goreboothero\\CsvUploader\\Validator\\FileContentTextCharsetValidator' => ['privates', 'Goreboothero\\CsvUploader\\Validator\\FileContentTextCharsetValidator', 'getFileContentTextCharsetValidatorService', true],
            'Goreboothero\\CsvUploader\\Validator\\ValidatorBuilder' => ['privates', 'Goreboothero\\CsvUploader\\Validator\\ValidatorBuilder', 'getValidatorBuilderService', true],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.3TAAYHd', 'get_ServiceLocator_3TAAYHdService', true],
            ...
            'Goreboothero\\CsvUploader\\Form\\FormFactoryBuilder' => '?',
            'Goreboothero\\CsvUploader\\Form\\Type\\CsvUploaderType' => '?',
            'Goreboothero\\CsvUploader\\Validator\\FileContentTextCharsetValidator' => '?',
            'Goreboothero\\CsvUploader\\Validator\\ValidatorBuilder' => '?',
