 ...
 */
class Goreboothero_CsvUploader_Http_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->aliases = [
            'Goreboothero\\CsvUploader\\Http\\Kernel' => 'kernel',
        ];
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/Goreboothero_CsvUploader_Http_KernelTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Goreboothero_CsvUploader_Http_KernelTestDebugContainer',
